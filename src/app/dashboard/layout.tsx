    ...
    <div className="relative min-h-screen overflow-hidden text-slate-900">
      ...
      <header className="sticky top-0 z-40">
        <div className="mx-auto max-w-7xl px-4">
          <div className="mt-3 rounded-2xl border border-white/40 bg-white/50 backdrop-blur-xl shadow-[0_8px_40px_rgba(31,41,55,.08)] px-4">
            <div className="h-14 flex items-center justify-between gap-4">
              ...
              {/* Nav pills */}
              <nav className="hidden md:flex items-center gap-1 rounded-full border border-white/60 bg-white/60 backdrop-blur px-1 py-1 shadow-sm">
