// src/app/dashboard/reschedule/ReschedulePageClient.tsx
"use client";
      ...
      <div className="flex items-center justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Busca por <strong>nombre</strong>, <strong>teléfono</strong> o
            filtra por <strong>fecha</strong>.
          </p>
        ...
        <table className="w-full text-sm">
          ...
          <tbody>
            {loading && rows.length === 0 ? (
              ...
              rows.map((b) => {
                const hour = new Date(b.starts_at).toLocaleTimeString(
                  "es-DO",
                  {
                    hour: "2-digit",
                    minute: "2-digit",
